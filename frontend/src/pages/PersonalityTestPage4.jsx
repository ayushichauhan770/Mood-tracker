...
import img1 from '../assets/personality/q4/1.jpg';
import img2 from '../assets/personality/q4/2.jpg';
import img3 from '../assets/personality/q4/3.jpg';
import img4 from '../assets/personality/q4/d-wooden classic.png';
...
const PersonalityTestPage4 = () => {
  ...
  const handleNext = () => {
    if (selectedOption) {
      savePersonalityResponse(4, selectedOption);
  ...
  return (
    <div className="personality-test-container">
      <h1 className="question">Q4: Which gate would you prefer?</h1>
