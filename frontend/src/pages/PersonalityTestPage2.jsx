...
import img1 from '../assets/personality/q2/1.jpg';
import img2 from '../assets/personality/q2/2.jpg';
import img3 from '../assets/personality/q2/3.jpg';
import img4 from '../assets/personality/q2/4.jpg';
...
const PersonalityTestPage2 = () => {
  ...
  const handleNext = () => {
    if (selectedOption) {
      savePersonalityResponse(2, selectedOption);
      navigate('/personality-test-page-3');
    }
  };

  const handlePrev = () => {
    navigate('/personality-test-page-1');
  };

  return (
    <div className="personality-test-container">
      <h1 className="question">Q2:which animal would youu like to connect the most?</h1>
