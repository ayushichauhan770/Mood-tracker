...
import img1 from '../assets/personality/q7/1.jpg';
import img2 from '../assets/personality/q7/2.jpg';
import img3 from '../assets/personality/q7/3.jpg';
import img4 from '../assets/personality/q7/4.jpg';
...
const PersonalityTestPage7 = () => {
  ...
  const handleNext = () => {
    if (selectedOption) {
      savePersonalityResponse(7, selectedOption);
  ...
  return (
    <div className="personality-test-container">
      <h1 className="question">Q7: select any one hand gesture that you think suit your personality</h1>
