...
import img1 from '../assets/personality/q9/1.jpg';
import img2 from '../assets/personality/q9/2.jpg';
import img3 from '../assets/personality/q9/3.jpg';
import img4 from '../assets/personality/q9/4.jpg';
...
const PersonalityTestPage9 = () => {
  ...
  const handleNext = () => {
    if (selectedOption) {
      savePersonalityResponse(9, selectedOption);
  ...
  return (
    <div className="personality-test-container">
      <h1 className="question">Q9: Which type of sky would you prefer?</h1>
