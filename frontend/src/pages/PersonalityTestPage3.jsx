...
import img1 from '../assets/personality/q3/1.jpg';
import img2 from '../assets/personality/q3/2.jpg';
import img3 from '../assets/personality/q3/3.jpg';
import img4 from '../assets/personality/q3/4.jpg';
...
const PersonalityTestPage3 = () => {
  ...
  const handleNext = () => {
    if (selectedOption) {
      savePersonalityResponse(3, selectedOption);
  ...
  return (
    <div className="personality-test-container">
      <h1 className="question">Q3:Pick the room that matches your vibe.</h1>
