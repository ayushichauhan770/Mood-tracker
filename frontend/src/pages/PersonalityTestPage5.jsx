...
import img1 from '../assets/personality/q5/1.jpg';
import img2 from '../assets/personality/q5/2.jpg';
import img3 from '../assets/personality/q5/3.jpg';
import img4 from '../assets/personality/q5/4.jpg';
...
const PersonalityTestPage5 = () => {
  ...
  const handleNext = () => {
    if (selectedOption) {
      savePersonalityResponse(5, selectedOption);
  ...
  return (
    <div className="personality-test-container">
      <h1 className="question">Q5: Do you prefer spending time alone or with a group?</h1>
