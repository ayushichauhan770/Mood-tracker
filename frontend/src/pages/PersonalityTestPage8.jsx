...
import img1 from '../assets/personality/q8/1.jpg';
import img2 from '../assets/personality/q8/2.jpg';
import img3 from '../assets/personality/q8/3.jpg';
import img4 from '../assets/personality/q8/4.jpg';
...
const PersonalityTestPage8 = () => {
  ...
  const handleNext = () => {
    if (selectedOption) {
      savePersonalityResponse(8, selectedOption);
  ...
  return (
    <div className="personality-test-container">
      <h1 className="question">Q8: Select any one shape.</h1>
